...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/outdated-browser/1.1.5/outdatedbrowser.css" />
			...
			<div class="col-md-4">
				<div class="panel panel-primary">
					...
					<div class="panel panel-body">
						...
						<?php if($maintenance_mode == "disabled"){ ?>
						
						<div class="tab-content tpl-tabs-cont">
							<div class="tab-pane fade active in" id="login-modal">
								<center><img src="<?php echo $website_url; ?>/images/bennys.png" width="40%"></center>
								</br>
								...
								<?php } else { ?>
									...
									<form action="<?php echo $website_url; ?>/api/authentication.php" method="POST">
										...
										<div class="form-group">
											<center><a href="#" class="btn btn-success login" id="login">Arbeiten</a></center>
										</div>
									</form>
								<?php } ?>
							</div>
						...
						<?php } else { ?>
							<div id="event"><center><p class="alert alert-danger">Aktuell sind Wartungsarbeiten!</p></center></div>
						<?php } ?>
					</div>
