		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-warning">
					<div class="panel panel-heading">Alle Staatsaufträge</div>
					<div class="panel panel-body">
						<table id="tasks" class="table-responsive">
							...
							<tbody>
								<?php
									$counter = 1;
									$sql = "SELECT * FROM staats Order By Id DESC";
...
<script>
    function catchme(token) {
        var windowcase = window.open("<?php echo $website_url; ?>/account/viewer?token=" + token + "&type=Staat", "", "width=500,height=500");
    }
